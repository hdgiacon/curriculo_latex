...
\\
\noindent \CVTextBlock{Em Python utilizo em projetos a biblioteca Pandas para exploração de dados, Seaborn para visualização de dados, Streamlit para criação de dashboards e a biblioteca Scikit-learn para modelos de \textit{machine learning}.}
...
\noindent \CVBlockWithTime{I.A. para Identificação de Padrões de Ervas}{Matte Leão}{}{2023 - em andamento}{\tab[0.01cm] Modelo de classificação
    de imagens para identificar ervas de acordo com os padrões \tab[0.01cm] estabelecidos pela empresa. \\ \tab[0.01cm] \textbf{tecnologias:} Pandas, MobileNet - Pytorch, Streamlit.}
